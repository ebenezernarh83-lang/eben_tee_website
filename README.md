...
as a one-way, server-keyed hash in KV. `ADMIN_RECOVERY_KEY` powers the **Forgot
your PIN?** form on the admin page. Keep the recovery code outside the repository
and never place it in HTML or JavaScript.
